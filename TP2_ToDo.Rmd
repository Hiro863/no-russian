...
>   - download the data (if not in the directory)
>   - rename substructures of the data for convenience
>   - calculate additional useful parameters (e.g. <i>nb_signals</i>)
...
>   - for each runs and for each indices check if the corresponding rows/columns contain the target character
>   - if so set the corresponding value in <i> classes</i> to <i>TRUE</i>
>   - this creates a vector of correct labels 
